...
const VERSAO = 'teotonio-v51'; // v51: correção de apontamento de equipamento, Projetos volta a trocar de prancha e o PDF Interno fala da obra aberta (index.html e js/equip mudaram)
